  ...
  return (
    <>
      ...
      <div className="container">
        ...
        {/* Video */}
        <div className={`video-container ${lesson.content_type === 'h5p' ? 'h5p-container' : ''}`}>
          ...
          <button
            ...
            disabled={progressClicked}
            style={{
              position: 'absolute',
              bottom: '10px',
              right: '10px',
              background: progressClicked ? 'green' : '#4b6cff',
              color: 'white',
              border: 'none',
              borderRadius: '3px',
              padding: '3px 6px',
              cursor: progressClicked ? 'not-allowed' : 'pointer',
              fontSize: '0.8rem',
              zIndex: 25
            }}
          >
