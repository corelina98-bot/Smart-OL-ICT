...
app.post("/login", async (req, res) => {
  try {
    ...
    // Special password verification for teacher and admin roles
    let isValidPassword = false;
    if (selectedRole === "teacher") {
      isValidPassword = password === "TeachGamified1011";
    } else if (selectedRole === "admin") {
      isValidPassword = password === "AdminGamified1011";
    } else {
      // For student role, check against stored password
...
app.listen(PORT, () => {
  ...
  console.log("GET  /api/notifications");        // For user
  console.log("GET  /api/notifications/all");    // For admin
  console.log("POST /api/notifications/create"); // For admin
  console.log("DELETE /api/notifications/:id");  // For admin
